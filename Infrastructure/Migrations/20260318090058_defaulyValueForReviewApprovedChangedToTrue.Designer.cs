...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260318090058_defaulyValueForReviewApprovedChangedToTrue")]
    partial class defaulyValueForReviewApprovedChangedToTrue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<string>("SpecialPlaceName")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingSpecialPlaceName")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.PayoutRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SubOrder", "SubOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.SubOrder", b =>
                {
                    b.HasOne("Domain.Entities.Order", "MasterOrder")
                        .WithMany("SubOrders")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.VendorWallet", b =>
                {
                    b.HasOne("Domain.Entities.Vendor", "Vendor")
                        .WithOne("Wallet")
                        .HasForeignKey("Domain.Entities.VendorWallet", "VendorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.WalletTransaction", b =>
                {
                    b.HasOne("Domain.Entities.VendorWallet", "Wallet")
                        .WithMany()
